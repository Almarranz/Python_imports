...
# =============================================================================
    ...
    gr_alpha, gr_color, gr_size = 1, 'r', 50  # TODO
    bg_alpha = 1
    cl_size = 300
    ...
    # =============================================================================
                ...
                # ax[0].scatter(X[:, 0][colores_index[-1]], X[:, 1][colores_index[-1]],
                ...
                ax[0].set_xlim(-15, 5)
                ax[0].set_ylim(-10, 10)
                ax[0].set_xlabel(f'$\\mu_{{{coor1}}}$ [mas/yr]', fontsize=30)
                ax[0].set_ylabel(f'$\\mu_{{{coor2}}}$ [mas /yr]', fontsize=30)
                ax[0].invert_xaxis()
                # ax[0].axis('scaled')
                ...
                ax[0].axhline(0, color = 'tab:orange')
                ax[0].axvline(0, color = 'tab:orange')
                ...
                if coor1 == 'l':
                    ...
                    ax[1].text(0.20, 0.95, f'Radius $\sim$ %.0f"\n # stars = %s\n {coor1} = %.3f {coor2} = %.3f ' % (rad.to(u.arcsec).value, len(colores_index[i][0]),clus_cent.ra.value,clus_cent.dec.value), transform=ax[1].transAxes, fontsize=30,
                           verticalalignment='top', bbox=prop)
                ...
                ax[1].invert_xaxis()
                ax[1].set_xlabel(f'{coor1}', fontsize=30)
                ax[1].set_ylabel(f'{coor2}', fontsize=30)
    ...
    # =============================================================================
                if 'color' in clustered_by:
                    ...
                    # ax[2].scatter(color_A -color_B, color_B,color=gr_color,
                    #               s=gr_size, zorder=1, marker='x', alpha=gr_alpha)
                    
                    ax[2].hexbin(color_A -color_B, color_B, cmap = 'Greys',
                                 norm = LogNorm(), gridsize = (30,30),zorder = 0)
                    ax[2].invert_yaxis()
                    ax[2].set_xlabel(f'{mag_A}-{mag_B}',fontsize=30)
                    ax[2].set_ylabel(f'{mag_B}', fontsize=30)
                    txt_color = '\n'.join((f'{mag_A}-{mag_B} =%.3f' % (np.median(color_A[colores_index[i]]-color_B[colores_index[i]])),
                                           f'$\sigma_{{{mag_A}-{mag_B}}}$ = %.3f' % (
